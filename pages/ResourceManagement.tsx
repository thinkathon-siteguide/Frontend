...
const ResourceManagement: React.FC = () => {
  ...
  const criticalItems = displayResources.filter(
    (r) => r.status === 'Critical'
  ).length;
    ...
    <div className="space-y-6 animate-fade-in">
          ...
          <div className="flex items-center gap-2 mt-2">
            <div
              className={`w-2 h-2 rounded-full ${
                criticalItems > 0 ? 'bg-red-500 animate-pulse' : 'bg-green-500'
              }`}
            ></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-soft border border-gray-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-bold text-thinklab-black mt-1">
              {totalItems}
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-[600px]">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl shadow-soft border border-gray-100 overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50/50">
            ...
            {filteredResources.map((item) => (
              <div
                key={item.id}
                className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between group hover:border-gray-300 transition-all"
              >
                <div className="flex items-center gap-4">
                  ...
                  ></div>
                  <div>
                    <h4 className="font-bold text-thinklab-black">
                      {item.name}
                    </h4>
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-xs text-thinklab-grey">
                ...
                <div className="flex items-center gap-6">
                  <div className="text-right">
                    <span className="block text-xl font-bold text-thinklab-black">
                      {item.quantity}
                    </span>
        ...
        <div className="bg-white rounded-3xl shadow-soft border border-gray-100 p-6 flex flex-col">
          <h3 className="font-bold text-thinklab-black mb-6">
            Stock Distribution
          </h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleAddSubmit} className="p-8 space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-thinklab-black text-white font-bold py-4 rounded-xl mt-4 hover:bg-gray-800 transition shadow-lg"
              >
                Confirm Addition
              </button>
            </form>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
            <div className="bg-thinklab-black text-white p-6 flex justify-between items-center">
              <div>
                <h3 className="font-bold text-xl flex items-center gap-2">
                  <Sparkles className="w-5 h-5 text-yellow-400" /> AI Resource
                  Planner
                </h3>
            ...
            <div className="p-6 bg-blue-50 border-b border-blue-100 flex items-start gap-4 mx-6 mt-6 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800/80 leading-relaxed">
                  The AI has analyzed your project type and phase to generate
                  this resource list. Confirming this plan will{' '}
                  <span className="font-bold underline">
                    replace your current inventory
                  </span>{' '}
                  for this workspace.
                </p>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-3">
              {suggestedResources.map((item, index) => (
                <div
                  key={index}
                  className="grid grid-cols-12 gap-4 p-4 border border-gray-100 rounded-xl bg-gray-50/50 hover:bg-white hover:shadow-md transition-all items-end"
                >
                  <div className="col-span-4">
                    ...
                    <input
                      ...
                      value={item.name}
                      onChange={(e) =>
                        handleUpdateSuggestion(index, 'name', e.target.value)
                      }
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      value={item.unit}
                      onChange={(e) =>
                        handleUpdateSuggestion(index, 'unit', e.target.value)
                      }
                      className="w-full p-2 bg-white border border-gray-200 rounded-lg text-sm font-bold text-thinklab-black focus:ring-1 focus:ring-thinklab-black outline-none"
                    />
                  </div>
