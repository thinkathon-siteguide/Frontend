    ...
    <div className="h-[calc(100vh-100px)] flex flex-col lg:flex-row gap-6 overflow-hidden animate-fade-in">
          ...
          <div className="flex gap-4 animate-fade-in-up">
            ...
            <div className="bg-white p-4 rounded-2xl rounded-tl-none shadow-sm border border-gray-100 max-w-[85%]">
              <p className="text-gray-600 text-sm leading-relaxed">
                Hello! I'm your AI architecture assistant. I can help you draft
                a comprehensive execution plan for{' '}
      ...
      <div
        className={`flex-1 flex flex-col transition-all duration-500 ${
          result ? 'translate-x-0 opacity-100' : 'translate-x-[20px] opacity-50'
        }`}
      >
        {result ? (
            ...
            <div className="bg-gradient-to-r  from-thinklab-black to-gray-800 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div className="flex justify-between items-start">
                  <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border border-white/10">
                    AI Generated Plan
                  </span>
              ...
              <div className="grid grid-cols-2 gap-4">
                {result.costEstimate && (
                  <div className="bg-white p-5 rounded-2xl shadow-soft border border-gray-100 hover:-translate-y-1 transition duration-300">
                    ...
                    <p className="text-2xl font-bold text-thinklab-black">
                      {result.costEstimate}
                    </p>
                  </div>
                )}
                ...
                <div className="p-6 space-y-6">
                  <div className="space-y-4">
                    {result.stages.map((stage, idx) => (
                      <div
                        key={idx}
                        className="group flex items-start p-3 hover:bg-gray-50 rounded-xl transition-colors border border-transparent hover:border-gray-100"
                      >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {result.materials.map((mat, idx) => {
                        ...
                        return (
                          <span
                            key={idx}
                            className="px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg text-xs font-medium text-gray-600 hover:border-gray-300 transition-colors cursor-default"
                          >
                            {displayText}
                          </span>
                        );
